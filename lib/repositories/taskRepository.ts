    ...
    if (state.evaluation) {
      await tx.evaluation.create({
        data: {
          ...
          completenessScore: state.evaluation.completenessScore,
          credibilityScore: state.evaluation.credibilityScore,
          differentiationScore: state.evaluation.differentiationScore,
          developabilityScore: state.evaluation.developabilityScore,
          clarityScore: state.evaluation.clarityScore,
          marketScore: state.evaluation.completenessScore,
          userPainScore: state.evaluation.credibilityScore,
          feasibilityScore: state.evaluation.developabilityScore,
          evidenceQualityScore: state.evaluation.credibilityScore,
